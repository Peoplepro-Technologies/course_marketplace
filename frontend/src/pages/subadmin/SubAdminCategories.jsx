/**
 * SubAdminCategories.jsx — Category Management for Sub Admin.
 *
 * Full CRUD for categories. Matches Super Admin pattern.
 */
...
export default function SubAdminCategories() {
  ...
  const handleCreate = async (e) => {
    ...
    try {
      await api.post('/subadmin/categories', { name: newCatName, description: newCatDesc });
      setNewCatName('');
      setNewCatDesc('');
      fetchCategories();
    } catch (err) {
  ...
  const handleUpdate = async (id) => {
    ...
    try {
      await api.put(`/subadmin/categories/${id}`, { name: editName, description: editDesc });
      setEditingId(null);
      fetchCategories();
    } catch (err) {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await api.delete(`/subadmin/categories/${id}`);
      fetchCategories();
    } catch (err) {
