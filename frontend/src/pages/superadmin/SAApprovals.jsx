/**
 * SAApprovals.jsx — Course Approvals for Super Admin.
 *
...
export default function SAApprovals() {
  ...
  const fetchCourses = useCallback(() => {
    setLoading(true);
    api.get('/superadmin/approvals/pending', { params: { page: data.page, page_size: data.page_size } })
  ...
  const handleApprove = async (courseId) => {
    ...
    try {
      await api.put(`/superadmin/approvals/${courseId}/approve`);
      fetchCourses();
    } catch (err) {
  ...
  const handleReject = async (courseId) => {
    ...
    setActionLoading(courseId);
    try {
      await api.put(`/superadmin/approvals/${courseId}/reject`, { reason });
      fetchCourses();
    } catch (err) {
