/**
 * SAReviewsModeration.jsx — Review Moderation for Super Admin.
 *
...
export default function SAReviewsModeration() {
  ...
  const handleModerate = async (reviewId, action) => {
    ...
    try {
      await api.put(`/superadmin/reviews/${reviewId}/moderate`, { action });
      fetchReviews();
    } catch (err) {
